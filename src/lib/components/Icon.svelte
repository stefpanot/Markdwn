<script lang="ts">
  ...
  const paths: Record<string, string> = {
    ...
    "strike": "M11.6 4.9a2.4 2.4 0 00-2.2-1.5H7a2.1 2.1 0 00-.6 4.1l2.5.9a2.1 2.1 0 01-.6 4H5.9a2.4 2.4 0 01-2.2-1.7 M2.4 8.2h11.2",
    "mark": "M10.6 2.5l2.9 2.9-7.3 7.3-3.3.7.7-3.3z M2.6 13.8h6",
  ...
  const extra: Record<string, string> = {
    ...
    "code-block": "M5.2 6h5.6M5.2 8.1h5.6M5.2 10.2h3.2",
